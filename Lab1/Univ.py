...
URL_1 = "https://kubg.edu.ua/prouniversitet/vizytivka/rektorat/dyrektory"   #Директори та декани
URL_2 = "https://kubg.edu.ua/prouniversitet/vizytivka/rektorat/pomichnyk-rektora"   #Помічник Ректора
URL_3 = "https://kubg.edu.ua/prouniversitet/vizytivka/rektorat/prorektory"       #Проректори
page = get(URL)
...
with open("univ.txt", "w", encoding="UTF=8") as file:
    ...
    file.write(f"\n{staff_title_1}\n")
    for div in staff_list_1.find_all("div"):
        staff_1 = div.find("a",text=True, recursive=False)
    ...
    staff_list_2 = staff_soup_2.find(class_="SobiPro staff")
    h3 = staff_list_2.find("h3")
    staff_title_2 = h3.find(text=True, recursive=False)
    file.write(f"\n{staff_title_2}\n")
    for div in staff_list_2.find_all("div"):
        staff_2 = div.find("a",text=True, recursive=False)
    ...
    h3 = staff_list_3.find("h3")
    staff_title_3 = h3.find(text=True, recursive=False)
    file.write(f"\n{staff_title_3}\n")
    for div in staff_list_3.find_all("div"):
        staff_3 = div.find("a",text=True, recursive=False)
